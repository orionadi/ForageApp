...
private val forageableDao: ForageableDao
    ...
    val Forgeables: LiveData<List<Forageable>> = forageableDao.getForegeables().asLiveData()

    // TODO : create method that takes id: Long as a parameter and retrieve a Forageable from the
    //  database by id via the DAO.
    fun getForgeable(id: Long): LiveData<Forageable> = forageableDao.getForageable(id).asLiveData()
